...
export default function Experience() {
  const items = [
    {
      title: "Senior UI/UX Designer at Kishoy International Top-up",
      link: "https://www.kishoy.com/en",
      icon: <Svg1 />,
      date: "02/2023 - Today",
      location: "Canada,Montréal",
      description:
        "I designed interfaces recharge platform, led initiatives  to optimize user interfaces, elevate user experience, and contribute to the evolution of  the platform's design language. Through strategic research and iterative design.",
    },
    {
      title: "Senior UI/UX Designer / Freelance work - Short term contract",
      link: "#0",
      icon: <Svg1 />,
    ...
    {
      title: "UI/UX Designer & Researcher at TechnoloGeek SaaS Company",
      link: "https://technologeek.vercel.app/",
      icon: <Svg1 />,
      date: "04/2022 - 01/2023",
      location: "Canada,Montréal",
      description:
        "I crafted advanced websites and digital solutions to cater  to our clients' evolving needs. An environment that thrived on creativity and staying ahead in technology trends, as a UI/UX designer and Front-end was instrumental in creating exceptional digital experiences.",
    },
    {
      title: "Junior UI/UX Designer at Davemed Global Services",
      link: "https://technologeek.vercel.app/",
      icon: <Svg1 />,
      date: "07/2021 - 02/2022",
      location: "Canada,Montréal",
      description:
        "I spearheaded initiatives to refine user  interfaces, elevate user experiences, and foster seamless interactions. My focus included crafting intuitive dashboards, optimizing workflows, and  contributing to a more user-centric platform.",
    },
    {
      title: "UI Designer / Freelance work - Short term contract",
      link: "#",
      icon: <Svg1 />,
